...
namespace chotel.Interfaces
{
    public class HotelRepository : IHotelRepository
    {
        ...
        public Task<List<Hotel>> GetAllHotelAsync() => _context.Hotels.ToListAsync();

        public Task<List<Hotel>> GetHotelByNameAsync(string name) =>
            _context.Hotels.Where(h => h.Name.Contains(name)).ToListAsync();

        public async Task<List<Hotel>> GetHotelCoordinatesAsync(Coordinate coordinate) =>
